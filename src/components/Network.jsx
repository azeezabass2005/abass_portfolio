        ...
        <div className='relative bg-[#131030] rounded-2xl m-10 sm:py-7 p-2'>
            <div className={`flex justify-around items-center sm:p-10 p-1 flex-wrap gap-10 sm:w-[93%] w-[100%] rounded-2xl`}>
                {myNetworks.map((friend, index) => (
                    <div key={friend.id} className={`sm:w-[316px] w-[296px] h-[256px] ${styles.flexCenter} bg-shine rounded-2xl flex-col`}>
                        <div className={`sm:w-[310px] w-[290px] h-[250px] friend-card rounded-2xl p-5 bg-secondary z-[3] flex flex-col justify-around`}>
                            <div className={`flex`}>
